 <section class="bg-dark bg-pt-0 pb-0">
   ...
   <div class="container">
     ...
     <div class="row justify-content-lg-around">
       ...
       <div class="col-6 col-sm-4 col-lg-auto mb-3 order-4 order-lg-1">
         <h6 class="text-light lh-lg text-uppercase">Features</h6>
         <ul class="list-unstyled mb-md-4 mb-lg-0">
           ...
           <li class="lh-lg"><a class="text-light fs--1 text-decoration-none" href="#!">DropShipping</a></li>
       ...
       <div class="col-6 col-sm-4 col-lg-auto mb-3 order-2 order-lg-4">
         ...
         <ul class="list-unstyled mb-md-4 mb-lg-0">
           <li class="lh-lg"><a class="text-light fs--1 text-decoration-none" href="#!">Experts</a></li>
       ...
       <div class="col-sm-12 col-md-6 px-md-0 text-md-center order-1 order-md-0">
         <div class="text-400 text-center">
           <p class="mb-0">&nbsp;
             ...
             </svg>&nbsp;by&nbsp;<a class="text-1000" href="#" target="_blank">AxExpress </a>
           </p>
         </div>
       </div>
 ...
 <!--    JavaScripts-->
 <!-- ===============================================-->
 <script src="<?php echo website_assets_url() ?>vendors/@popperjs/popper.min.js"></script>
 <script src="<?php echo website_assets_url() ?>vendors/bootstrap/bootstrap.min.js"></script>
 <script src="<?php echo website_assets_url() ?>vendors/is/is.min.js"></script>
 <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
 <script src="<?php echo website_assets_url() ?>assets/js/theme.js"></script>
