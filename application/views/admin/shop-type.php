...
<body class="hold-transition sidebar-mini layout-fixed">
    <input type="hidden" id="tablename" value="shop_type">
    <div class="wrapper">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            if ($permission['view'] == 'yes') {
                                ...
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Super Category List</h3>
                                    </div>
                                    <div class="card-body">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title text-white">Add Super Category</h4>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12 pr-1">
                                    <label class="form-label">Name Of Super Category<span
                                            id="nameMessage"></span></label>
                                    <input type="text" class="form-control" name="name" id="name"
                                        onblur="checkUniqueDetails('name','nameMessage','name');"
                                        placeholder="eg. Grocery, Medical etc">
                                </div>
                                <div class="form-group col-md-12">
                                    <center><img id="blah" src="<?php echo base_url() ?>image/default-image.png"
                                            alt="Category Image" class="img img-circle img-thumbnail img-responsive"
        ...
        <div class="modal fade" id="editModal" data-backdrop="static" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Edit Super Category</h4>
...
<script>
    ...
    function listData() {
        var table = $("#dataListing").DataTable({
            ...
            "autoWidth": false,
            "ajax": {
                url: "<?php echo base_url() ?>ajax/shopTypeListing/getShopType",
                type: 'POST',
                data: {
