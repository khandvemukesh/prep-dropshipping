...
<body class="hold-transition sidebar-mini layout-fixed">
    <input type="hidden" id="tablename" value="unit">
    <div class="wrapper">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title text-white">Add Unit</h4>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12 pr-1">
                                    <label class="form-label">Name Of Unit<span id="nameMessage"></span></label>
                                    <input type="text" class="form-control" name="name" id="name" onblur="checkDetails('name','nameMessage');" placeholder="eg. Kg,Gm etc">
                                </div>
                            </div>
                            <hr>
                    ...
                    <form id="editForm" method="POST">
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12 pr-1">
                                    <label class="form-label">Name Of Unit <span id="enameMessage"></span></label>
                                    <input type="text" class="form-control" name="name" id="edit_name" onblur="checkDetails('edit_name','enameMessage');" placeholder="eg. Kg, Gm etc">
                                </div>
                            </div>
                            <hr>
                            <div class="modal-footer">
...
<script>
    ...
    function listData() {
        var table = $("#dataListing").DataTable({
            ...
            "autoWidth": false,
            "ajax": {
                url: "<?php echo base_url() ?>ajax/unitListing/getUnit",
                type: 'POST',
                data: {
