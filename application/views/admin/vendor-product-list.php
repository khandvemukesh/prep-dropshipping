                        ...
                        <div class="col-12">
                            <div class="card card-outline card-primary">
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <h3 class="card-title">Vendors Product List (Vendor Name : <?php echo $vendorObj->shop_name ?>)</h3>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <select class="form-control" name="sub_category" id="search_sub_category">
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $subCategoryRow->id ?>"><?php echo $subCategoryRow->name ?></option>
                                                        <?php
                                                        }
                                                        ?>
                                                    </select>
                                                ...
                                                <div class="form-group col-md-2">
                                                    <select class="form-control" name="shop_type" id="shop_type_category">
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $shopTypeRow->id ?>"><?php echo $shopTypeRow->name ?></option>
                                                        <?php
                                                        }
                                                        ?>
                                                    </select>
                            ...
                            ?>
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Vendors Product List <span class="text-danger">(Vendor Name : <?php echo $vendorObj->shop_name ?>)</span></h3>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select name="sub_category_id" id="sub_category_id" class="form-control" onblur="checkDetails('sub_category_id','subCategoryMessage');">
                                    ...
                                    ?>
                                        <option value="<?php echo $subCategoryObj->id ?>"><?php echo $subCategoryObj->name ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
...
<script>
    ...
    function listData() {
        var table = $("#dataListing").DataTable({
            ...
            "autoWidth": false,
            "ajax": {
                url: "<?php echo base_url() ?>ajax/productListing/getVendorProduct",
                type: 'POST',
                data: {
