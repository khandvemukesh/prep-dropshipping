...
<body class="hold-transition sidebar-mini layout-fixed">
    <input type="hidden" id="tablename" value="category">
    <div class="wrapper">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="shop_type" id="shop_type" class="form-control" onblur="checkDetails('shop_type','shopTypeMessage');">
                                        <option value="">-- Select Super Category --</option>
                                        <?php
                                        foreach ($shopTypeData->result() as $shopTypeObj) {
                                        ?>
                                            <option value="<?php echo $shopTypeObj->id ?>"><?php echo $shopTypeObj->name ?>
                                            </option>
                                        <?php
                                        }
                                        ?>
                                ...
                                <div class="form-group col-12 pr-1">
                                    <label class="form-label">Name Of Category<span id="nameMessage"></span></label>
                                    <input type="text" class="form-control" name="name" id="name" onblur="checkUniqueDetails('name','nameMessage','name');" placeholder="eg. Fruites, Vegitables etc">
                                </div>
                                <div class="form-group col-md-12">
                                    <center><img id="blah" src="<?php echo base_url() ?>image/default-image.png" alt="Category Image" class="img img-circle img-thumbnail img-responsive" width="150" height="150"></center>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="shop_type" id="edit_shop_type" class="form-control" onblur="checkDetails('edit_shop_type','eshopTypeMessage');">
                                        <option value="">-- Select Super Category --</option>
                                        <?php
                                        foreach ($shopTypeData->result() as $shopTypeObj) {
                                        ?>
                                ...
                                <div class="form-group col-12 pr-1">
                                    ...
                                    <input type="text" class="form-control" name="name" id="edit_name" onblur="checkUniqueDetails('edit_name','enameMessage','name');" placeholder="eg. Fruites, Vegitables etc">
                                </div>
                                <div class="form-group col-md-12">
                                    <center><img id="edit_blah" src="<?php echo base_url() ?>image/default-image.png" alt="City Image" class="img img-circle img-thumbnail img-responsive" width="150" height="150"></center>
...
<script>
    ...
    function listData() {
        var table = $("#dataListing").DataTable({
            ...
            "autoWidth": false,
            "ajax": {
                url: "<?php echo base_url() ?>ajax/categoryListing/getCategory",
                type: 'POST',
                data: {
