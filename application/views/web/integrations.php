  ...
  <section class="py-0 bg-light-gradient">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-5 order-md-1 pt-8"><img class="img-fluid" src="<?php echo website_assets_url() ?>assets/img/gallery/ebay.jpg" alt="" /></div>
        <div class="col-md-7 col-lg-6 text-center text-md-start pt-5 pt-md-9">
          <h1 class="display-2 fw-bold fs-4 fs-md-5 fs-xl-6">Integrations </h1>
          <p class="mt-3 mb-4">Dropshipping apps for seamless integration with your favourite eCommerce platforms</p>
    ...
    <div class="container">
      <div class="row flex-center">
        <div class="col-auto text-center my-4">
          <h1 class="display-3 fw-bold">Your Integrations With</span></h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-4 mb-5 mb-md-0"><img class="img-fluid shadow-sm" src="<?php echo website_assets_url() ?>assets/img/gallery/ebay.jpg"" alt="" />
              <div class=" mt-3 text-center text-md-start">
          <h4 class="display-6 fs-2 fs-lg-3 fw-bold">Shopify</h4>
          <p class="mb-0">Add AX XPRESS plugin to any WordPress site and set up a new store in minutes.</p><a class="btn fileText ps-0" href="#" role="button"> Connect with Shopify ›</a>
        </div>
      </div>
      <div class="col-md-4 mb-5 mb-md-0"><img class="img-fluid shadow-sm" src="<?php echo website_assets_url() ?>assets/img/gallery/ebay.jpg"" alt="" />
              <div class=" mt-3 text-center text-md-start">
        <h4 class="display-6 fs-2 fs-lg-3 fw-bold">eBay</h4>
        <p class="mb-0">From subscriptions to gym classes to luxury cars, AX XPRESS is fully customizable.</p><a class="btn fileText ps-0" href="#" role="button"> Connect with Tiktok › </a>
      </div>
    </div>
    <div class="col-md-4 mb-5 mb-md-0"><img class="img-fluid shadow-sm" src="<?php echo website_assets_url() ?>assets/img/gallery/ebay.jpg"" alt="" />
              <div class=" mt-3 text-center text-md-start">
      <h4 class="display-6 fs-2 fs-lg-3 fw-bold">Tiktok</h4>
      <p class="mb-0">AX XPRESS is one of the fastest-growing eCommerce communities. </p><a class="btn fileText ps-0" href="#" role="button"> Connect with Tiktok ›</a>
    </div>
    </div>
    </div>
